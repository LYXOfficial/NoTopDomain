...
class Ui_NoTopDomain(object):
    def setupUi(self, NoTopDomain):
        ...
        self.gridLayout_5.addWidget(self.line_4, 7, 0, 1, 3)
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.TopDomainLocationSet = QtWidgets.QLineEdit(self.groupBox_3)
        self.TopDomainLocationSet.setEnabled(True)
        self.TopDomainLocationSet.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.TopDomainLocationSet.setReadOnly(True)
        self.TopDomainLocationSet.setObjectName("TopDomainLocationSet")
        self.horizontalLayout_6.addWidget(self.TopDomainLocationSet)
        self.toolButton = QtWidgets.QToolButton(self.groupBox_3)
        self.toolButton.setObjectName("toolButton")
        self.horizontalLayout_6.addWidget(self.toolButton)
        self.gridLayout_5.addLayout(self.horizontalLayout_6, 8, 1, 1, 2)
        ...
        self.gridLayout_5.addLayout(self.horizontalLayout_5, 10, 0, 1, 3)
    ...
    def retranslateUi(self, NoTopDomain):
        ...
        self.label_16.setText(_translate("NoTopDomain", "极域路径修改"))
