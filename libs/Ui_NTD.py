...
class Ui_NoTopDomain(object):
    def setupUi(self, NoTopDomain):
        ...
        self.KillSome.setMaximumSize(QtCore.QSize(100, 16777215))
        ...
        self.gridLayout_3.addWidget(self.RestartExplorer, 3, 4, 1, 1)
        self.NoImg = QtWidgets.QPushButton(self.groupBox_2)
        self.NoImg.setObjectName("NoImg")
        self.gridLayout_3.addWidget(self.NoImg, 3, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.ToolsYes, 3, 1, 1, 1)
        self.MouseYes = QtWidgets.QCheckBox(self.groupBox_2)
        self.MouseYes.setObjectName("MouseYes")
        self.gridLayout_3.addWidget(self.MouseYes, 0, 4, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.UnlockTDHook, 1, 4, 1, 1)
        self.NoControl = QtWidgets.QCheckBox(self.groupBox_2)
        self.NoControl.setObjectName("NoControl")
        self.gridLayout_3.addWidget(self.NoControl, 2, 4, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.checkBox_4, 3, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.PigeonGames, 0, 1, 1, 1)
    ...
    def retranslateUi(self, NoTopDomain):
        ...
        self.label_2.setText(_translate("NoTopDomain", "启动任务管理器"))
        ...
        self.checkBox_4.setText(_translate("NoTopDomain", "强力杀进程（基于ntsd/实验性）"))
        self.checkBox.setText(_translate("NoTopDomain", "隐藏托盘"))
        self.checkBox_3.setText(_translate("NoTopDomain", "禁用QSS"))
        self.checkBox_2.setText(_translate("NoTopDomain", "修改窗口化时自动缩放窗口"))
        ...
        self.label_11.setText(_translate("NoTopDomain", "大小：0MB"))
        ...
        self.label_14.setText(_translate("NoTopDomain", "<a href=\"https://github.com/lyxofficial/notopdomain/releases\">查看更新日志</a>"))
        self.plainTextEdit.setPlainText(_translate("NoTopDomain", "获取中..."))
        self.label_15.setText(_translate("NoTopDomain", "新版下载完毕，请手动替换"))
        self.pushButton_5.setText(_translate("NoTopDomain", "启动新版"))
        self.pushButton_4.setText(_translate("NoTopDomain", "打开位置"))
