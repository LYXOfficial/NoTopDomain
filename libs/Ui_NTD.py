...
class Ui_NoTopDomain(object):
    def setupUi(self, NoTopDomain):
        ...
        self.gridLayout_6.addWidget(self.reStart, 9, 1, 1, 1)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_6.addItem(spacerItem, 8, 0, 1, 2)
        ...
        self.gridLayout_6.addLayout(self.formLayout, 6, 0, 1, 2)
        ...
        self.gridLayout_6.addWidget(self.checkBox_3, 1, 0, 1, 2)
    ...
    def retranslateUi(self, NoTopDomain):
        ...
        self.checkBox_4.setText(_translate("NoTopDomain", "启动强力杀进程（基于ntsd）（实验性）"))
