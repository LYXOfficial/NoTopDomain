...
本软件已测试过：极域2015 v5.0 极域2016 v6.0 极域2021 v6.0。
...
使用 {} 快捷启动任务管理器，并且启动后软件会自动勾选置顶选项，它的置顶层级比极域的功能更高。
...
`PspTTBP` 即为调用Windows的未公开函数 `PspTerminateThreadByProcess` 来杀掉极域，可以绕过反杀。
