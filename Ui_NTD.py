...
class Ui_NoTopDomain(object):
    def setupUi(self, NoTopDomain):
        ...
        self.HangUpTD.setMaximumSize(QtCore.QSize(70, 16777215))
        ...
        self.gridLayout_2.addWidget(self.KillCurrent, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.KillTD, 0, 2, 1, 1)
        self.GBWindowed = QtWidgets.QPushButton(self.groupBox)
        self.GBWindowed.setMaximumSize(QtCore.QSize(70, 16777215))
        ...
        self.KillSome.setMinimumSize(QtCore.QSize(100, 0))
        self.KillSome.setMaximumSize(QtCore.QSize(0, 16777215))
        self.KillSome.setObjectName("KillSome")
        self.gridLayout_2.addWidget(self.KillSome, 1, 1, 1, 1)
        self.EnableTDBar = QtWidgets.QPushButton(self.groupBox)
        self.EnableTDBar.setMaximumSize(QtCore.QSize(120, 16777215))
        self.EnableTDBar.setObjectName("EnableTDBar")
        self.gridLayout_2.addWidget(self.EnableTDBar, 1, 2, 1, 1)
